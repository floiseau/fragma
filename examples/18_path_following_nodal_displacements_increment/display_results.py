...
u1_bot = df["displacement 1 [0.001, 0.0167, 0]"]
u2_bot = df["displacement 2 [0.001, 0.0167, 0]"]
u1_top = df["displacement 1 [0.001, 0.0217, 0]"]
u2_top = df["displacement 2 [0.001, 0.0217, 0]"]
