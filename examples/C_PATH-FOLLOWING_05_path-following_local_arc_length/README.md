# Path-following using local arc-length

## Description

This example simulates the crack propagation in a CT specimen with a load control method based a local arc-length method.
