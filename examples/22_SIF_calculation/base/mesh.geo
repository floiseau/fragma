...
Point(14) = { a*Cos(alpha), a*Sin(alpha), 0, h_crack}; 	// Left crack tip
Point(15) = {-a*Cos(alpha),-a*Sin(alpha), 0, h_crack}; 	// Right crack tip
Point(16) = {-L/2, 0, 0, h};     			// Mid left node
// Top
Point(21) = {-L/2, L/2, 0, h};
Point(22) = { L/2, L/2, 0, h};
// Point(13) = { L/2, 0, 0, h};				// Mid right node
// Point(14) = { a*Cos(alpha), a*Sin(alpha), 0, h}; 	// Left crack tip
// Point(15) = {-a*Cos(alpha),-a*Sin(alpha), 0, h}; 	// Right crack tip
// Point(16) = {-L/2, 0, 0, h};      			// Mid left node
